  ...
  return (
    ...
    >
      <a
        ...
        role="listitem"
        className="flex h-11 w-11 items-center justify-center rounded-full bg-[#22c55e] text-white shadow-[0_4px_14px_-3px_rgba(34,197,94,0.55)] transition-transform duration-300 ease-out hover:scale-110 motion-reduce:transition-none sm:h-12 sm:w-12"
      >
        <LinkedInIcon className={`${iconBase} text-white`} />
      </a>
      ...
      <a
        ...
        role="listitem"
        className="flex h-11 w-11 items-center justify-center rounded-full border border-white/40 text-white/90 transition-all duration-300 ease-out hover:scale-110 hover:border-white hover:text-white motion-reduce:transition-none sm:h-12 sm:w-12"
      >
      ...
      <a
        ...
        role="listitem"
        className="group relative flex h-11 w-11 items-center justify-center rounded-full border border-white/40 text-white/90 transition-all duration-300 ease-out hover:scale-110 hover:border-white hover:text-white motion-reduce:transition-none sm:h-12 sm:w-12"
      >
